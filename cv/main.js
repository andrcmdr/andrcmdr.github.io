var MenuData = [
    ...
    {content:'Payment requisites', header: false, menus: [
        ...
        {content:'<div class="form-group"><label for="litecoin">Litecoin (LTC):</label><div class="input-group"><input class="form-control" id="litecoin" placeholder="LQBLv5LT84xcsgGsNEumEJkXSxqeLzLyNd" value="LQBLv5LT84xcsgGsNEumEJkXSxqeLzLyNd" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("litecoin"); }},
        {content:'<div class="form-group"><label for="dogecoin">Dogecoin (DOGE):</label><div class="input-group"><input class="form-control" id="dogecoin" placeholder="DGf4oEEKzyT1QQuDb9KE4Mhawrswe8Bx3i" value="DGf4oEEKzyT1QQuDb9KE4Mhawrswe8Bx3i" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("dogecoin"); }},
        {content:'<div class="form-group"><label for="bitcoin-cash">Bitcoin Cash (BCH):</label><div class="input-group"><input class="form-control" id="bitcoin-cash" placeholder="qzpe36snpykdl60k9gwp8jxs4erq9ek6mypgagknn2" value="qzpe36snpykdl60k9gwp8jxs4erq9ek6mypgagknn2" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("bitcoin-cash"); }},
        {content:'<div class="form-group"><label for="bitcoin-sv">Bitcoin SV (BSV):</label><div class="input-group"><input class="form-control" id="bitcoin-sv" placeholder="qzpe36snpykdl60k9gwp8jxs4erq9ek6mypgagknn2" value="qzpe36snpykdl60k9gwp8jxs4erq9ek6mypgagknn2" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("bitcoin-sv"); }},
        {content:'<div class="form-group"><label for="bitcoin-gold">Bitcoin Gold (BTG):</label><div class="input-group"><input class="form-control" id="bitcoin-gold" placeholder="Gc7DZboLkRTvogbHhiYrmmupHpZP5pLDqg" value="Gc7DZboLkRTvogbHhiYrmmupHpZP5pLDqg" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("bitcoin-gold"); }},
        {content:'<div class="form-group"><label for="ethereum">Ethereum (ETH):</label><div class="input-group"><input class="form-control" id="ethereum" placeholder="0xeABBcEA63A23649F0Eb4B3D893714d880D05fd8A" value="0xeABBcEA63A23649F0Eb4B3D893714d880D05fd8A" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("ethereum"); }},
        {content:'<div class="form-group"><label for="ethereum-classic">Ethereum Classic (ETC):</label><div class="input-group"><input class="form-control" id="ethereum-classic" placeholder="0xeABBcEA63A23649F0Eb4B3D893714d880D05fd8A" value="0xeABBcEA63A23649F0Eb4B3D893714d880D05fd8A" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("ethereum-classic"); }},
        {content:'<div class="form-group"><label for="stellar-lumen">Stellar Lumen (XLM):</label><div class="input-group"><input class="form-control" id="stellar-lumen" placeholder="GBCH2MR5BX2BNJ756GWBNJNJ4Q4APR4UVYTMOYX4VDWDDM2O4GWKLSRF" value="GBCH2MR5BX2BNJ756GWBNJNJ4Q4APR4UVYTMOYX4VDWDDM2O4GWKLSRF" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("stellar-lumen"); }},
        {content:'<div class="form-group"><label for="ripple">Ripple (XRP):</label><div class="input-group"><input class="form-control" id="ripple" placeholder="rKkU65jH4xL3wEUqrzzLds9W3bCEqxqKME" value="rKkU65jH4xL3wEUqrzzLds9W3bCEqxqKME" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("ripple"); }},
        {content:'<div class="form-group"><label for="zcash">ZCash (ZEC):</label><div class="input-group"><input class="form-control" id="zcash" placeholder="t1gJb5RC9ksTCjGu6yF5V3d32PpMj3LjGX1" value="t1gJb5RC9ksTCjGu6yF5V3d32PpMj3LjGX1" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("zcash"); }},
        {content:'<div class="form-group"><label for="dash">Dash (DASH):</label><div class="input-group"><input class="form-control" id="dash" placeholder="XqjXxBa6W1VdDPV21ptiBURJHEfMWy79EY" value="XqjXxBa6W1VdDPV21ptiBURJHEfMWy79EY" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("dash"); }},
        {content:'<div class="form-group"><label for="digibyte">DigiByte (DGB):</label><div class="input-group"><input class="form-control" id="digibyte" placeholder="D9MwM543tm4ze49pgzmq8ehhzL5wi8yVmi" value="D9MwM543tm4ze49pgzmq8ehhzL5wi8yVmi" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("digibyte"); }},
        {content:'<div class="form-group"><label for="tron">TRON (TRX):</label><div class="input-group"><input class="form-control" id="tron" placeholder="TCfSj8S3v5rGFUArAnLULcWbi8x7vQeYjv" value="TCfSj8S3v5rGFUArAnLULcWbi8x7vQeYjv" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("tron"); }},
        {content:'<div class="form-group"><label for="cardano">Cardano (ADA):</label><div class="input-group"><input class="form-control" id="cardano" placeholder="DdzFFzCqrht5a644CGSKCdQUz1Gmp6yu1HgrgnihNLHkcBmfQEnEDSkF3JDKDRwaY11wRApzCCmRKwQf8DSwgPGwyNijodbnjRU9WC1a" value="DdzFFzCqrht5a644CGSKCdQUz1Gmp6yu1HgrgnihNLHkcBmfQEnEDSkF3JDKDRwaY11wRApzCCmRKwQf8DSwgPGwyNijodbnjRU9WC1a" type="text" readonly><div class="input-group-btn"><button class="btn btn-success" type="button"><i class="fa fa-clone"></i></button></div></div></div>', callback: function() { getText("cardano"); }},
        {content:'sm_divider'},
