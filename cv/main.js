var MenuData = [
    ...
    {content:'CV in English', header: false, menus: [
        ...
        {content:'<i class="fa fa-file-code-o"></i> Web-HTML', url:'https://commandr.stream/cv.en'},
    ...
    {content:'CV in Russian', header: false, menus: [
        ...
        {content:'<i class="fa fa-file-code-o"></i> Web-HTML', url:'https://commandr.stream/cv.ru'},
